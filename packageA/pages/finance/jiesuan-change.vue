<template>
	<view class="jiesuang">
		<u-navbar leftText="结算信息变更" :fixed="true" bgColor="#fff" :autoBack="false" :safeAreaInsetTop="true"
		...
		<common-view>
			<view class="register ">
				...
				<p class="pannel-title">上传本人银行卡（储蓄卡卡号面）照片</p>
				<view class="pannel">
					<view class="pannel-body">
						<view class="upload">
							...
							<u-upload :fileList="fileList" :capture="['camera']" @afterRead="afterRead"
				...
				<view class="pannel">
					<u--form :model="form" ref="form" labelPosition="left" labelWidth="80" :borderBottom="true">
						...
						<u-form-item label="开户账号" prop="banknum" class="input-item" :borderBottom="true">
							<u--input v-model="form.banknum" type="number" fontSize="14" placeholder="请填写开户账号"  :style="{pointerEvents: 'none'}"
								color="#333333" border="none">
							</u--input>
						</u-form-item>
						...
						<picker-address @change="change">
							<u-form-item label="开户省市" prop="city" borderBottom @click="showCity = true; hideKeyboard()"
								ref="item1">
								<!-- <u--input v-model="provinceca"  disabledColor="#ffffff" placeholder="请选择地区"
									border="none"></u--input> -->
						...
						<u-form-item label="支行名称" prop="ZhName" borderBottom @click="showBank = true; hideKeyboard()"
							ref="item1">
						<!-- 	<u--input v-model="form.ZhName" disabledColor="#ffffff" placeholder="请选择地区"
								border="none"></u--input> -->
		...
		methods: {
			...
			submit() {
				...
				this.$refs.form.validate().then(res => {
					getbank_BianGengAdd(this.form).then((res) => {
						if (res.code == '00') {
