<template>
	<view class="jiesuang">
		<u-navbar leftText="交易提额" :fixed="true" bgColor="#fff" :autoBack="false" :safeAreaInsetTop="true"
			...
			<view class="pannel">
				<u--form :model="form" ref="form" labelPosition="left" labelWidth="80" :borderBottom="true">
						...
						<view class="pannel-body">
							<view class="upload">
								...
								<u-upload :fileList="fileList"  @afterRead="afterRead"
									@delete="deletePic" name="6" multiple :maxCount="1" width="250" height="150">
					...
					<u-form-item label="开户账号" prop="banknum" class="input-item" :borderBottom="true">
						<u--input v-model="form.banknum" type="text" fontSize="14" placeholder="请填写开户账号" color="#333333"
							border="none">
						</u--input>
					</u-form-item>
					<u-form-item label="身份证号" prop="cardnum" class="input-item" :borderBottom="true">
						<u--input v-model="form.cardnum" type="number" fontSize="14" placeholder="请填写身份证号"
							color="#333333" border="none">
						</u--input>
					</u-form-item>
					...
					<u-form-item label="绑定手机号" prop="mobile" borderBottom>
						<u--input v-model="form.mobile" type="number" disabledColor="#ffffff" placeholder="请填写绑定手机号"
							border="none"></u--input>
					</u-form-item>
		...
		methods: {
			...
			submit() {
				...
				this.$refs.form.validate().then(res => {
					getbank_tier_submit(this.form).then((res) => {
						if (res.code == '00') {
							uni.showToast({
								title: res.msg,
								icon: 'success'
			...
			reset() {
				this.fileList = []
				const validateList = ['bankname', 'banknum', 'cardnum', 'mobile', 'yzcode']
