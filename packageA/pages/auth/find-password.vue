		...
		<view class="register-form">
			<u--form :model="form" ref="form">
				...
				<u-form-item  prop="mobile" class="input-item margin-bottom-m">
					<u-input v-model="form.mobile" type="number" placeholder="请输入注册的手机号码" fontSize="20" color="#181818" shape="circle"
			...
			<view class="action-btn">
				...
				<u-button :disabled="checked.length == 0" @click="submit" :loading="loading"
					:loadingText="loading?'设置中..':''" :customStyle="{'border-radius': '10rpx'}" size="large"
					type="primary" text="设置新密码">
				</u-button>
			</view>
